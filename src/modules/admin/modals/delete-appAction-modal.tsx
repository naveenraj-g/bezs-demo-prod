...
import { deleteAppAction } from "../serveractions/admin-actions";
import { useState } from "react";
import { Loader2 } from "lucide-react";

export const DeleteAppActionModal = () => {
  ...
  const isModalOpen = isOpen && modalType === "deleteAppAction";
  ...
  async function handleAppMenuItemDelete() {
    ...
    try {
      setIsLoading(true);
      await deleteAppAction({ appActionId });
      ...
      <DialogContent className="p-8">
        <DialogHeader>
          ...
          <DialogDescription className="mb-6 text-md">
            Are you sure you want to delete this App Action? This action cannot
            be undone.
          </DialogDescription>
